class JournalsController < ApplicationController
  ...
  def stats
    ...
    @journals = Journal.paginate(:page => params[:page], :per_page => 50, :order => 'created_on DESC', :limit  => 200) 
    # puts params[:page]
    # @journals = Journal.paginate_by_sql(['select * from journals order by created_on DESC limit 300'],:page => params[:page])
  end
