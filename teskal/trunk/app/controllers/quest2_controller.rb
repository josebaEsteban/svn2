...
class Quest2Controller < ApplicationController
  ...
  def teskal_chart_2
    ...
    if @answers.length > 1
      ...
      strXML = "<chart caption='"+l(:quest2_label_0)+"' subCaption='"+@user.name+"' yAxisName='"+@fecha.to_s+"' palette='2' yAxisMinValue='-10' yAxisMaxValue='10' showShadow='1' use3DLighting='1' legendAllowDrag='1' useRoundEdges='1' noValue='0' showValues='0' bgcolor='ffffff' borderColor='ffffff' numDivLines='7'>"
    end
