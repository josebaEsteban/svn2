class Quest5Controller < ApplicationController
  ...
  def teskalChart5
    ...
    if @answers.length > 1
      #Create the chart - Pie 3D Chart with data from strXML
      @chart1= renderChart("/charts/MSCombi2D.swf"+l(:PBarLoadingText), "", strXML, "quest5", 780, 300, false, false)
    else
