class Quest16Controller < ApplicationController
  layout 'base'
  ...
  def teskalChart10
    ...
    for answer in @answers
      ...
      if answer.id == @id
        ...
        strXML = strXML+l_datetime(TzTime.zone.utc_to_local(answer.created_on))+"' anchorSides='5' lineThickness='1' "
      end
